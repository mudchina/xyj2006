...
"$N似乎已经打中了$n时，$n突然原地疾转，化为一片黑影不见了。\n",
		"dodge_power":		10,
		"parry_msg":
"$n连忙使一招"+HIW"「借尸还魂」"NOR"，举$W一挡，借势疾退开去。\n",
		"parry_power":		10,
        ]),
        ([      "name":                 "尸山血海",
                "action":
"$N左手运起排山倒海的掌力，右手$w舞出夺目的寒光，笼罩住$n的全身",
		...
		"parry":		-20,
                ...
                "damage_type":  	"劈伤",
		"dodge_msg":
"$n平平跃起，在空中连转数圈，落在$N身后。原来是"+HIR"「尸山血海」"NOR"。\n",
		"dodge_power":		10,
		"parry_msg":
"$n展开$W疾挥，但见漫天刀影，这招"+HIR"「尸山血海」"NOR"果然将$N的攻势挡了回去。\n",
		"parry_power":		10,
        ]),
        ([      "name":                 "毁尸灭迹",
                "action":
...
"$N虽然看得一清二楚，却道不出这招"+HIW"「毁尸灭迹」"NOR"的奥妙。\n",
		"dodge_power":		10,
		"parry_msg":
...
"这招"+HIW"「行尸走肉」"NOR"虽然凶险，但威力奇大，逼的$n连连倒退",
                ...
                "damage_type":  	"砍伤",
		"dodge_msg":
"$n忙用一招"+HIW"「行尸走肉」"NOR"，膝盖不弯，硬梆梆地连蹦数下，居然避过了$N的招数。\n",
		"dodge_power":		10,
		"parry_msg":
