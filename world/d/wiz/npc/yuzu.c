...
string *msg_d = ({
                      ...
                      "fUck","FUcK","FUCk","FuCk","鬼儿子","SHit","sHit","SHIt","ShiT",
                      "你奶奶的","和你妈做爱","她妈的","你爷爷的","有没有喘气的","cao","CAO","Cao",
                      "放你妈的屁","操你妈","日死你","干你娘","没死回？","瓜娃子","瓜的","瓜批",
                      "干你娘","操你姐","狗屁wiz","狗wiz","破wiz","死wiz","日死你",
                      "干你妈","干你的","ｆｕｃｋ","ＦＵＣＫ","F u c k","f u c k","蛋子","你妈","你爹",
                      "靠！","靠!","我靠","放屁","吃屎","操你妈","打炮","6mang","大便","小便","caobi",
                      "手淫","淫",});
