...
int do_yanwu()
{
 ...
 if((string)me->query("family/family_name")!="将军府")
   ...
   me->start_busy(5);
   me->improve_skill("lengquan-force",random((int)(me->query("spi")+me->query("int"))/2),1);
   me->improve_skill("baguazhou",random((int)(me->query("spi")+me->query("int"))/2),1);
  me->add("faith",1);
