...
"这招"+HIM"「八方风雨」"NOR"虽然露出若干空门，但$n也不敢不顾自身安危而贸然进攻",
      "dodge":     5,
      "parry":           -5,
      "damage":     40,
      "damage_type":   "刺伤",
...
//      "post_action":   (:set_busy:),
    ...
    ([
      "action":
"$N连人带剑猛扑向$n的$l。若是这招"+HIR"「九死一生」"NOR"
...
//   if(!arg||arg==" ")arg="七修剑绝技"+chinese_number(sizeof(m_actions)+1);
   m_act+=(["name":arg]);
   msg= skill_head[random(sizeof(skill_head))]+BLINK+RED"「"+arg+"」"NOR
