...
"$N脸上突现煞气，举起手中$w，猛向$n$l击落，这招"+BLINK""+RED"「再堕轮回」"NOR"出手又快又狠",
     ...
     "parry":               -15,
        ...
        ([      "name":   "渡劫",
    "action" : HIW"\n$N默吟佛号，手中的"+NOR"$w"+NOR+HIW+"带一层淡淡的白雾直直拍向$n的胸前，这第一招名唤「渡劫」"NOR,
    "dodge" : -15,
    "damage" : 40,
    "force"  : 100,
    "parry"  :-120,
	...
	([      "name":   "渡难",
    "action" : HIW"\n$N手中"+NOR"$w"+NOR+HIW"一振，白色劲气已然布满全身，风雷之声渐起，这第二式「渡难」猛然拍出"NOR,
    "dodge" : -15,
    "damage" : 50,
    "parry"  :-100,
    "force"  : 120,
	...
	([      "name":   "渡厄",
    "action" : HIW"\n$N梵唱又起，"+NOR"$w"+NOR+HIW"象鼓满了风的劲帆，汹涌而出，「渡厄」一式之凶险显见佛家动嗔也会做“狮子吼”"NOR,
    "dodge" : -10,
    "damage" : 60,
    "parry"  :-100,
    "force"  : 120,
	...
	([      "name":   "慈光普渡",
    "action" : HIC"\n$N轻声禅唱“回头是岸”，周身七尺劲气涌动，这普陀佛门禅功的无上功力终化作「慈光普渡」澎湃而出"NOR,
    "dodge" : -10,
    "damage" : 80,
    "parry"  :-120,
    "force"  : 120,
...
void name_skill(object me, string arg)
{
   ...
   content=me->query("str")+me->query_skill("unarmed",1)/4;
   m_act+=(["damage":content]);
   content=-me->query("spi");
   m_act+=(["dodge" :content]);
   content=-me->query("cps");
   m_act+=(["parry" :content]);
   content=me->query("con")+4*me->query_skill("force",1)/10;
   m_act+=(["force" :content]);
