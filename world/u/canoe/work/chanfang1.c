...
void reward(object me)
{
	...
	kind  = me->query("canoetask/kind");     
        ...
        else if ( kind == "收" ) kind_bonus=1000;
          ...
          {case "杀": {
          	        ...
          	        switch (level)
                            {case 1:{me->add("canoetask_log/kill1",1);
                              ...
                              case 3: me->add("canoetask_log/kill3",1);
                             }
                         break;
                      }
          case "擒": {
          	        ...
          	        switch (level)
                            {case 1:{me->add("canoetask_log/arrest1",1);
                              ...
                              case 3: me->add("canoetask_log/arrest3",1);
                             }
                         break;
                      }
          case "劝": {
          	        ...
          	        switch (level)
                            {case 1:{me->add("canoetask_log/persuade1",1);
                              ...
                              case 3: me->add("canoetask_log/persuade3",1);
                             }
                         break;
                      }
          case "降": {
          	        ...
          	        switch (level)
                            {case 1:{me->add("canoetask_log/fight1",1);
                              ...
                              case 3: me->add("canoetask_log/fight3",1);
                             }
                     }                        
          }
}                               
